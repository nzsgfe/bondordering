    ...
    return (
      <React.Fragment>
        ...
        <div className="main-portal-div">
          <div className="back-div-style" onClick={() => window.location.hash = "#/order/list"}>
            {`< Bond Order List`}
          </div>
          <div className="main-portal-style">
            ...
            <div className="bond-info-row4">
              <div className="cancel-button" onClick={onClearOrder}>
                <img className="button-img-style" src="../../assets/images/cancelLogo.png" alt="" />
                Clear
              </div>
              <div className="submit-button" onClick={onAddNewOrder}>
                <img className="button-img-style" src="../../assets/images/submitLogo.png" alt="" />
                Submit
              </div>
            </div>
          </div>
